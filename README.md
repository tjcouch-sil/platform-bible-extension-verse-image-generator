# platform-bible-extension-verse-image-generator

Platform.Bible Extension - Generates images based on current verse or other prompt. For OCE Learn-a-thon Spring 24

## Presentation Links

- [Walkthrough video for creating this extension - OCE Learn-a-thon Spring 2024](https://drive.google.com/file/d/12F6XpNu9cjtF9Z6Phe-7GuWWlearcw27/view?t=50m57s)
- [Walkthrough doc for creating this extension - OCE Learn-a-thon Spring 2024](https://docs.google.com/document/d/1U2UN-VqEkLtyCYozoXYp98ZlpzvEM0rgsCtU19YxICI)
- [Final walkthrough code - Tag `v0.0.1`](https://github.com/tjcouch-sil/platform-bible-extension-verse-image-generator/tree/v0.0.1)
- [Platform.Bible Extensions presentation - OCE Learn-a-thon Spring 2024](https://docs.google.com/presentation/d/1L33hHibMWbmm5_IlfD6HBYjUCnkDr-DyYVqKIoPO248)
- [Links to resources for creating extensions](https://docs.google.com/document/d/1KBvnmwTxaO5h4Rq8PV82v2GELNslyVKCbFJ1-FV3TVQ/edit#heading=h.lp1j2x84y1qd)
...
- `src/` contains the source code for the extension
  ...
  - `src/types/verse-image-generator.d.ts` is this extension's types file that defines how other extensions can use this extension through the `papi`. It is copied into the build folder
